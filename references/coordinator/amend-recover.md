...
- Interrupted transactions, stale locks and Coordinator replacement follow [recovery](../recovery.md). `coordinator-takeover` and `bootstrap-recover` require `--runtime-receipt-file` naming the new `--coordinator-agent-id`.
